...
public class AboutGameManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        aboutText.text =
            ...
            "vki y‚ftd pqukSfr;k¡ ysrs gSa tks fn[kkrh gSa fd çkjafHkd ,vkbZ ¼tSls Logic Theorist½ us fuf'pr fu;eksa ls " +
            ...
            "<b>ihth Nk=ksa ds fy, cuk;k x;k</b>\n" +
            "yksftdk flQZ ,d xse ugha gSA ;g et+s ds :i esa fNik ,d ç;ksx'kkyk gSA\n" +
            "LukrdksÙkj Nk=ksa ds fy, fMt+kbu] ;g vkidh idM+ dks etcwr djrk gS:\n" +
            "• foospukRed rdZ\n" +
            "• çrhdkRed rdZ'kfä\n" +
            "• vuqes; iSVuZ\n" +
            "• ,vkbZ vs ,e,y çfreku\n\n" +
